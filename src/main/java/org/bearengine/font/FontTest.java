...
public class FontTest {
    ...
    public static void CreateFont(){
        ...
        try {
            font = java.awt.Font.createFont(java.awt.Font.TRUETYPE_FONT, FontTest.class.getResourceAsStream("/main/java/resources/fonts/Open-Sans/OpenSans-Regular.ttf"));

            Debug.log("FontTest -> FontTest Name: " + font.getFontName());
