...
import org.bearengine.debug.SystemInfo;
import org.bearengine.gui.*;
import org.bearengine.gui.GUIElement.AnchorPoint;
import org.bearengine.math.primitives.Line;
import org.bearengine.math.primitives.Plane;
import org.bearengine.math.primitives.Rect3D;
import org.bearengine.objects.Billboard;
import org.bearengine.objects.GameObject;
import org.bearengine.objects.ObjectManager;
import org.bearengine.objects.Skybox;
import org.bearengine.physics.MousePicker;
import org.bearengine.physics.Ray;
...
import org.engine.input.Keyboard;
import org.engine.input.Mouse;
import org.game.graphics.*;
import org.joml.Quaternionf;
import org.joml.Vector3f;
import org.lwjgl.opengl.GL11;
import org.lwjgl.opengl.GL20;
import org.voxelgame.data.LoadChunks;
import org.voxelgame.data.World;

public class GameLogic_Test implements IGameLogic {
	...
	@Override
	public void init(Window window, Renderer renderer, Camera camera){
		camera.setPosition(-5, 153, 10);
...
//		billboard.getBoundingBox().updateBounds(billboard.getMesh());
	...
	@Override
	public void update(float deltaTime, Window window, Camera camera, MousePicker mousePicker) {
		camera.movePosition(cameraInc.x * deltaTime, cameraInc.y * deltaTime, cameraInc.z * deltaTime, 1);
		mousePicker.update();
		
		//Update camera based on mouse
		if(Mouse.isPressed(Mouse.MOUSE_BUTTON_RIGHT)){
			Window.lockAndHideMouse(true);
			camera.changeRotation(new Quaternionf(Mouse.deltaY * MOUSE_SENSITIVITY * deltaTime, Mouse.deltaX * MOUSE_SENSITIVITY * deltaTime, 0f));
		}else{
			Window.lockAndHideMouse(false);
		}
...
//		}
	...
	@Override
	public void render(Window window, Renderer renderer, MousePicker mousePicker) {
