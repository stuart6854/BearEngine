...
import org.bearengine.math.Vector3i;
import org.bearengine.objects.GameObject;
import org.bearengine.utils.CollectionUtils;
...
public class Chunk extends GameObject{
    ...
    public Chunk(World world, WorldPos pos) {
		...
		this.world = world;
		this.pos = pos;
		super.setName("Chunk " + pos.x + ", " + pos.z);
	}
    ...
    public void updateMesh(MeshData meshData) {
        ...
        getMesh().clearMeshData();
        
        getMesh().setVertices(CollectionUtils.ListToArrayFloat(meshData.vertices));
        getMesh().setTextureCoords(CollectionUtils.ListToArrayFloat(meshData.uv));
        getMesh().setIndices(CollectionUtils.ListToArrayInt(meshData.indices));
        getMesh().setVertexColors(CollectionUtils.ListToArrayFloat(meshData.vertexColors));
        
        getMesh().flushToBuffers();
